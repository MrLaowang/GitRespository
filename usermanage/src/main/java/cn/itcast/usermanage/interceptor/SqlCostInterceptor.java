package cn.itcast.usermanage.interceptor;
...
@Intercepts({@Signature(type = StatementHandler.class, args = { Statement.class,ResultHandler.class }, method = "query"),
...
public class SqlCostInterceptor implements Interceptor{
	 ...
	 * @throws Exception 
	 */
	private String handleCommonParameter(String sql,List<ParameterMapping> parameterMappings,
	 ...
	 * @return
	 */
	private String handleMapParameter(String sql, Map<?, ?> paramMap,List<ParameterMapping> parameterMappings) {
		for (ParameterMapping parameterMapping : parameterMappings) {
	 ...
	 * @return
	 */
	private boolean isList(Class<? extends Collection> clazz) {
